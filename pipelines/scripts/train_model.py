...
def parse_args():
    ...
    parser.add_argument("--train_data", type=str, help="Path to prepped trained data")
    parser.add_argument("--test_data", type=str, help="Path to prepped test data")
    ...
    parser.add_argument("--test_report", type=str, help="Path of test report")
